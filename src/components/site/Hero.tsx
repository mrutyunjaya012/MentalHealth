...
export function Hero() {
  return (
    <section id="top" className="relative pt-32 pb-20 bg-hero overflow-hidden">
      <div className="mx-auto max-w-6xl px-4 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              href="#about"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-gradient-primary text-primary-foreground shadow-elegant hover:opacity-95 transition"
            >
              Explore research <ArrowRight className="w-4 h-4" />
            </a>
            <a
              href="#predict"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-xl glass hover:bg-card transition"
            >
        ...
        >
          ...
          <div className="relative rounded-3xl overflow-hidden glass shadow-elegant">
            <img
              src={heroImg}
              alt="Neural network brain visualization for AI mental health prediction"
              width={1280}
              height={1024}
          ...
          <motion.div
            ...
            className="absolute -bottom-6 -left-6 glass rounded-2xl p-4 shadow-soft hidden sm:block"
          >
