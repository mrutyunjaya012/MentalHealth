...
const people = [
  { n: "Dr. A. Mehta", r: "Principal Investigator", a: "Dept. of Computer Science" },
  { n: "S. Ramirez", r: "ML Researcher", a: "Health Informatics Lab" },
  { n: "L. Okafor", r: "Data Scientist", a: "Behavioral Analytics Group" },
];
      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {people.map((p) => (
            <div
              key={p.n}
              className="rounded-2xl p-6 bg-card border border-border shadow-soft hover:shadow-elegant transition"
            >
