...
export function Ethics() {
  return (
    <section id="ethics" className="py-24 bg-secondary/40">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {items.map((i) => (
            <div
              key={i.t}
              className="rounded-2xl p-6 bg-card border border-border shadow-soft hover:-translate-y-1 hover:shadow-elegant transition"
            >
