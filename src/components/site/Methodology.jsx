...
export function Methodology() {
    return (<section id="methodology" className="py-24 bg-secondary/40">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="relative grid md:grid-cols-4 gap-4">
          ...
          {steps.map((s, i) => (<motion.div key={s.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="relative rounded-2xl p-6 bg-card border border-border shadow-soft hover:shadow-elegant transition">
